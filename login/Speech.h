...
//QString ApiKey = "49vZqoME6BvkX1ChoVGSEoVe";
//QString SecretKey = "X4C5txzsFmiR2a3ew6sv6KZaMsClCtl0";

//语音识别相关
const QString BaiduSpeechSatrtUrl = "http://vop.baidu.com/server_api?dev_pid=1537&cuid=%1&token=%2"; //普通话测试
...
////const QString BaiduSpeechClientID = "49vZqoME6BvkX1ChoVGSEoVe";                                 //AK
////const QString BaiduSpeechClientSecret = "X4C5txzsFmiR2a3ew6sv6KZaMsClCtl0";     //SK

//////语音识别的Url
////const QString BaiduSpeechSatrtUrl ="http://vop.baidu.com/server_api?dev_pid=1537&cuid=%1&token=%2"; //普通话测试 //80001识别普通话  %1:本机标识 %2:获取的token
/////*
