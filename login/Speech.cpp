...
QString Speech::speechIdentify(QString audioFile)
{
    ...
    QString speechUrl = QString(BaiduSpeechSatrtUrl).arg("test").arg(accessToken);
    //QString speechUrl = QString(BaiduSpeechSatrtUrl).arg(BaiduSpeechClientID).arg(BaiduSpeechClientSecret);
    // QString speechUrl = QString(BaiduSpeechSatrtUrl);
    /* 把文件转换成QByteArray */
    QFile file;
